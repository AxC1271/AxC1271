...
| **RISC-V SoC v2** | 5-stage pipelined RV32I processor with split L1 caches (direct-mapped I-cache, 2-way D-cache). Complete RTL implementation, STA analysis (58.8 MHz post-synth, 85 MHz FPGA), formal verification. SystemVerilog. [View Repo →](https://github.com/AxC1271/RISCV-v2) |
